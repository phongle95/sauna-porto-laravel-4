...
<div class="sidebar-wrapper">
        ...
        <ul class="simple-entry-list">
            ...
            <li>
                ...
                <div class="entry-info">
                    <a style="color:#0088cc;" href="{{ route('trangchu.chitiet.news',['slug'=>str_slug($item->tieuDe),'id'=>$item->id,'ma'=>$item->maLoaiTin]) }}">{{ $item->tieuDe }}</a>
    ...
    <div class="widget">
            ...
            <div class="widget widget-featured">
                    <h2><span class="badge badge-primary" style="color:#fff;">Sản Phẩm Bán Chạy</span></h2>
